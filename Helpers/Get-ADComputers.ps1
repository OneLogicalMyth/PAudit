...
[cmdletbinding()]
param([int]$ActiveDays=60,[string]$DomainName=$env:USERDNSDOMAIN,[string]$Username,[string]$Password)
    ...
    if([string]::IsNullOrEmpty($Username) -OR [string]::IsNullOrEmpty($Password)){
        ...
        $Domain = New-Object System.DirectoryServices.DirectoryEntry("LDAP://$DomainName",$Username,$Password)
    }
